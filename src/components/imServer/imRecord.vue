                ...
                <el-tabs v-model="activeName" class="tab">
                    ...
                    <div class="item" v-for="(tmpEn, index) in storeCurrentChatEnlist" :key="index" @click="selectChat(tmpEn)" v-bind:class="{ active: selectedChatEn!=null && tmpEn.clientChatId==selectedChatEn.clientChatId}">
                        <div class="followicon-wrapper">
                            <i class="iconfont icon-zhidingwujiaoxing position-h-v-mid" :class="{ active: tmpEn.isFollow}" ></i>
                        </div>
                        <!-- 客户端头像 -->
                    ...
                    <div class="item" v-for="(tmpEn, index) in storeCurrentChatEnlist_done" :key="index" @click="selectChat(tmpEn)" v-bind:class="{ active: selectedChatEn!=null && tmpEn.clientChatId==selectedChatEn.clientChatId}">
                        <div class="followicon-wrapper">
                            <i class="iconfont icon-zhidingwujiaoxing position-h-v-mid" :class="{ active: tmpEn.isFollow}" ></i>
                        </div>
                        <!-- 客户端头像 -->
